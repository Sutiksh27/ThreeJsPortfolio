import {
  ...
  const experiences = [
    {
      ...
      points: [
        "Devised a Python bot reducing manual effort by 75% enabling batch downloads of images generated by Midjourney to system and automating the scheduling and posting of content across various social media platforms increasing reach & engagement by 15%",
        "Incorporated Open AI API to create a custom GPT for university site with data scraped from university site using Python & Beautiful Soup, reducing the time to obtain information by 60%",
      ],
    },
    {
  ...
  const testimonials = [
    ...
    {
      testimonial:
        "I've never met a web developer who truly cares about their work & success like Sutiksh does.",
      name: "Vedant Jain",
      designation: "SDE",
      company: "Amazon",
    },
